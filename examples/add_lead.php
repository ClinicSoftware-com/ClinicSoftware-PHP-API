...
// request
$data = array();
$data['name']            = 'Valeriu'; // mandatory
$data['surname']         = 'ClinicSoftware';
$data['postcode']        = 'BR1 1AB';
$data['address']         = '[API] ' . $dummy_data['location']['street']['name'];
$data['phone']           = '011111111' . random_int(10, 1000);
$data['phone_work']      = '022222222' . random_int(10, 1000);
$data['email']           = 'valeriu@clinicsoftware.com'; // mandatory, must be valid and unique
